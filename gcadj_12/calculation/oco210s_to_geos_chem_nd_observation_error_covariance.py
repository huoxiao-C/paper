...
oco210s_dir = '/share/nas1_share1/huoxiao_share/CO2_data/Observation_data/satellite_10s_average/OCO2_Litev9_ND/'
oco2pos_dir = '/share/nas1_share1/huoxiao_share/CO2_data/Observation_data/satellite_on_gc_2x25grid/OCO2_CO2_Litev9_ND/'
...
while (oco2_cur_time_date != oco2_end_time_date):
    ...
    while (begin_time_file != (oco2_cur_time_date + datetime.timedelta(days=1))):
        ...
        if len(time_list) != 0:
            ...
            print('outfile', oco2_out_file_path)
