...
out_oco2_dir = '/share/nas1_share1/huoxiao_share/CO2_data/Observation_data/satellite_10s_average/OCO2_Litev9_ND/'

oco2_begin_time_str = "2018-02-01 00:00:00"
...
while(oco2_cur_time_date!=oco2_end_time_date):
    ...
    #assignment
    xco2_day = tmp_xco2_day_omeq0_gd
    lon_day = tmp_lon_day_omeq0_gd
    lat_day = tmp_lat_day_omeq0_gd
    co2_prior_day = tmp_co2_prior_day_omeq0_gd
    xco2_prior_day = tmp_xco2_prior_day_omeq0_gd
    pres_day = tmp_pres_day_omeq0_gd
    surfp_day = tmp_surfp_day_omeq0_gd
    xco2_uncert_day = tmp_xco2_uncert_day_omeq0_gd
    pressure_weight_day = tmp_pressure_weight_day_omeq0_gd
    xco2_avk_day = tmp_xco2_avk_uncert_day_omeq0_gd
    time_day = tmp_time_day_omeq0_gd
