...
out_oco2_dir = '/share/nas1_share1/huoxiao_share/CO2_data/Observation_data/satellite_10s_average/OCO2_Litev9_ND_plus_Glintland_plus_Glintwater/'

oco2_begin_time_str = "2016-10-01 00:00:00"
oco2_end_time_str = "2017-01-01 00:00:00"
...
while(oco2_cur_time_date!=oco2_end_time_date):
    ...
    print(in_oco2_dir + '{:0>4d}/oco2_LtCO2_{:0>2d}{:0>2d}{:0>2d}'.format(oco2_cur_time_date.year,\
        oco2_cur_time_date.year%2000, oco2_cur_time_date.month,oco2_cur_time_date.day) + '_B9003r*')
    #Determine if the file exists,
    if subprocess.call('test -f ' + in_oco2_dir + '{:0>4d}/oco2_LtCO2_{:0>2d}{:0>2d}{:0>2d}'.format(oco2_cur_time_date.year,\
        oco2_cur_time_date.year%2000, oco2_cur_time_date.month,oco2_cur_time_date.day) + '_B9003r*',shell=True):
        oco2_cur_time_date += datetime.timedelta(days=1)
        continue

    os.chdir(in_oco2_dir)
    command_output = subprocess.check_output("ls  "+ '{:0>4d}/oco2_LtCO2_{:0>2d}{:0>2d}{:0>2d}'.format(oco2_cur_time_date.year,\
        oco2_cur_time_date.year%2000, oco2_cur_time_date.month,oco2_cur_time_date.day) + '_B9003r*',shell=True)
    ...
    #glint land
    tmp_xco2_day_omeq1_land_gd = tmp_xco2_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd==0)]
    tmp_lon_day_omeq1_land_gd = tmp_lon_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0)]
    tmp_lat_day_omeq1_land_gd = tmp_lat_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0)]
    tmp_co2_prior_day_omeq1_land_gd = tmp_co2_prior_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0), :][0]
    tmp_xco2_prior_day_omeq1_land_gd = tmp_xco2_prior_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0)]
    tmp_pres_day_omeq1_land_gd = tmp_pres_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0), :][0]
    tmp_surfp_day_omeq1_land_gd = tmp_surfp_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0)]
    tmp_xco2_uncert_day_omeq1_land_gd = tmp_xco2_uncert_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0)]
    tmp_pressure_weight_day_omeq1_land_gd = tmp_pressure_weight_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0), :][0]
    tmp_xco2_avk_uncert_day_omeq1_land_gd = tmp_xco2_avk_uncert_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0), :][0]
    tmp_time_day_omeq1_land_gd = tmp_time_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 0)]


    #glint ocean
    tmp_xco2_day_omeq1_ocean_gd = tmp_xco2_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd==1)]
    tmp_lon_day_omeq1_ocean_gd = tmp_lon_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1)]
    tmp_lat_day_omeq1_ocean_gd = tmp_lat_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1)]
    tmp_co2_prior_day_omeq1_ocean_gd = tmp_co2_prior_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1), :][0]
    tmp_xco2_prior_day_omeq1_ocean_gd = tmp_xco2_prior_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1)]
    tmp_pres_day_omeq1_ocean_gd = tmp_pres_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1), :][0]
    tmp_surfp_day_omeq1_ocean_gd = tmp_surfp_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1)]
    tmp_xco2_uncert_day_omeq1_ocean_gd = tmp_xco2_uncert_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1)]
    tmp_pressure_weight_day_omeq1_ocean_gd = tmp_pressure_weight_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1), :][0]
    tmp_xco2_avk_uncert_day_omeq1_ocean_gd = tmp_xco2_avk_uncert_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1), :][0]
    tmp_time_day_omeq1_ocean_gd = tmp_time_day_omeq1_lo_gd[np.where(tmp_lo_flag_omeq1_lo_gd == 1)]

    #glint land+ocean
    tmp_xco2_day_omeq1_gd = np.concatenate((tmp_xco2_day_omeq1_land_gd, tmp_xco2_day_omeq1_ocean_gd), axis=0)
    tmp_lon_day_omeq1_gd = np.concatenate((tmp_lon_day_omeq1_land_gd, tmp_lon_day_omeq1_ocean_gd), axis=0)
    tmp_lat_day_omeq1_gd = np.concatenate((tmp_lat_day_omeq1_land_gd, tmp_lat_day_omeq1_ocean_gd), axis=0)
    tmp_co2_prior_day_omeq1_gd = np.concatenate((tmp_co2_prior_day_omeq1_land_gd, tmp_co2_prior_day_omeq1_ocean_gd), axis=0)
    tmp_xco2_prior_day_omeq1_gd = np.concatenate((tmp_xco2_prior_day_omeq1_land_gd, tmp_xco2_prior_day_omeq1_ocean_gd), axis=0)
    tmp_pres_day_omeq1_gd = np.concatenate((tmp_pres_day_omeq1_land_gd, tmp_pres_day_omeq1_ocean_gd), axis=0)
    tmp_surfp_day_omeq1_gd = np.concatenate((tmp_surfp_day_omeq1_land_gd, tmp_surfp_day_omeq1_ocean_gd), axis=0)
    tmp_xco2_uncert_day_omeq1_gd = np.concatenate((tmp_xco2_uncert_day_omeq1_land_gd, tmp_xco2_uncert_day_omeq1_ocean_gd), axis=0)
    tmp_pressure_weight_day_omeq1_gd = np.concatenate((tmp_pressure_weight_day_omeq1_land_gd, tmp_pressure_weight_day_omeq1_ocean_gd), axis=0)
    tmp_xco2_avk_uncert_day_omeq1_gd = np.concatenate((tmp_xco2_avk_uncert_day_omeq1_land_gd, tmp_xco2_avk_uncert_day_omeq1_ocean_gd), axis=0)
    tmp_time_day_omeq1_gd = np.concatenate((tmp_time_day_omeq1_land_gd, tmp_time_day_omeq1_ocean_gd), axis=0)
    #assignment
